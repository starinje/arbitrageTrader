...
class geminiService:
	...
	def executeTradeOld(self):
		print('Inside executeTradeOld ...')

	def executeTrade(self):
		print('Inside executeTrade ...')

	def newOrder(self):
		print('Inside newOrder ...')

	def cancelOrders(self):
		print('Inside cancelOrders ...')
	...
	def orderHistory(self):
		print('Inside orderHistory ...')

        # ## Build test payload dict ...
        # pl = {
        ...
        # #API secret ...
        # api_secret =""
        # ## Build login/authentication dict ...
        # options = {
        # 		   "sandbox":True, 
        # 		   "key":"123",
        # 		   "secret":"1234abcd",
        ...
        # ## Instantiate object ...
        # gem_exchange = geminiService(options)

        # ## Test ...
        # gem_exchange.requestPublic()
